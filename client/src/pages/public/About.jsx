  ...
  return (
    <div className="pt-5 mt-5 container">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-5">
        <h1 className="fw-bold text-main">About Hirovate</h1>
      ...
      <div className="row g-5 align-items-center mb-5">
        ...
        <div className="col-lg-6">
          ...
          <p className="text-muted fs-5">
            At Hirovate, we believe that talent should seamlessly meet opportunity. We've built an enterprise-grade platform that removes the friction from university placements.
          </p>
